        ...
        <div>
          ...
          <div className="footerContacts">
            <a href={site.phoneHref}>
              <Phone size={15} />
              {site.phoneName} — {site.phoneDisplay}
            </a>
            <a href={site.whatsappHref} target="_blank" rel="noopener noreferrer">
              <MessageCircle size={15} />
              WhatsApp {site.phoneName}
            </a>
            <a href={site.secondaryPhoneHref}>
              <Phone size={15} />
              {site.secondaryPhoneName} — {site.secondaryPhoneDisplay}
            </a>
            <a href={site.secondaryWhatsappHref} target="_blank" rel="noopener noreferrer">
              <MessageCircle size={15} />
              WhatsApp {site.secondaryPhoneName}
            </a>
          ...
          <p className="smallText">
            <Link href="/contact">Request support</Link><br />
            <Link href="/privacy">Privacy</Link> · <Link href="/cookies">Cookies</Link>
          </p>
        </div>
      </div>
