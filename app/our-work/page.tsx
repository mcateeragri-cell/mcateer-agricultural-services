...
import { jamesWhatsApp } from "@/lib/site";
...
export default function Page(){
  const whatsappHref = jamesWhatsApp("Hi McAteer Agricultural Services, I’ve seen your recent work and would like to discuss a job.");
return <>
